...
export default function ThemeToggle() {
  ...
  return (
    ...
    bg-linear-to-r from-blue-50 via-sky-50 to-blue-100
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full overflow-hidden">
        <div
          className={`absolute inset-0 bg-linear-to-r from-amber-200/40 via-orange-300/30 to-amber-200/40
      transition-all duration-700 ease-in-out
      ${darkMode ? "opacity-0 scale-90" : "opacity-100 scale-100"}`}
        />
        <div
          className={`absolute inset-0 bg-linear-to-r from-indigo-900/40 via-purple-900/30 to-indigo-900/40
      transition-all duration-700 ease-in-out
      ...
      before:bg-linear-to-br before:from-amber-200 before:to-orange-300
      before:opacity-20 before:transition-all before:duration-700
      before:scale-110
      dark:before:opacity-0 dark:before:scale-100
      after:absolute after:inset-0 after:rounded-full
      after:bg-linear-to-br after:from-blue-500 after:to-purple-600
      ...
      >
        ...
        <div className="relative w-full h-full rounded-full overflow-hidden flex items-center justify-center">
          <div
            className={`absolute inset-0 bg-linear-to-br from-amber-400/30 to-orange-500/30
        transition-opacity duration-700
        ${darkMode ? "opacity-0" : "opacity-100"}`}
          />
          <div
            className={`absolute inset-0 bg-linear-to-br from-blue-400/30 to-purple-500/30
        transition-opacity duration-700
        ${darkMode ? "opacity-100" : "opacity-0"}`}
          />
      ...
      ${darkMode ? "opacity-0" : "opacity-100"}`}
        ...
        <div
          className={`absolute -inset-1.5 rounded-full blur-md
      bg-linear-to-r from-blue-500/40 to-purple-600/40
      transition-opacity duration-1000 ease-out
      ${darkMode ? "opacity-100" : "opacity-0"}`}
        />
      </div>
