...
export default function Detail() {
  return (
    <div className="bg-[#0b0d14] min-h-screen text-white font-sans selection:bg-yellow-500 selection:text-black">
      <TopBar />
      ...
      <div className="relative w-full h-screen md:h-[85vh]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0b0d14]/30 via-[#0b0d14]/60 to-[#0b0d14]" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0b0d14]/90 via-[#0b0d14]/40 to-transparent" />
        </div>

        {/* Hero Content */}
        <div className="relative z-10 h-full flex flex-col justify-end px-8 md:px-16 pb-16 max-w-4xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="bg-yellow-500 text-black text-[10px] font-black px-2 py-1 rounded uppercase tracking-wider">
              Featured
            </span>
          ...
          <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter text-white mb-4 uppercase">
            {MOVIE_DATA.title}
          </h1>
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mb-10 relative pl-4">
            <span className="absolute left-0 top-0 bottom-0 w-0.5 bg-yellow-800"></span>
            {MOVIE_DATA.synopsis_short}
          </p>

          <div className="flex flex-wrap gap-4">
            <button className="bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-4 rounded-md font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition">
              <Heart size={16} fill="black" /> Add to Favorite
            </button>
            <button className="bg-white/5 hover:bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-md font-bold text-xs uppercase tracking-wider flex items-center gap-2 border border-white/10 transition">
      ...
      <div className="px-8 md:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-b border-gray-800 pb-16">
          ...
          <div className="md:col-span-6">
            <h3 className="text-yellow-500 text-xs font-black uppercase tracking-widest mb-8">
              Metadata
            </h3>
            ...
            <div>
              <div className="mt-8 flex flex-wrap gap-2">
                {MOVIE_DATA.genres.map((genre) => (
                  <span
                    key={genre}
                    className="text-[10px] font-bold text-yellow-400 bg-yellow-500/10 border border-yellow-500/30 px-3 py-1 rounded-full uppercase hover:bg-yellow-500/20 hover:border-yellow-500/50 transition cursor-default"
                  >
                    {genre}
                  </span>
                ))}
          ...
          <div className="md:col-span-6">
            ...
            <p className="text-gray-400 leading-loose text-sm md:text-base mb-12">
              ...
              <div className="flex -space-x-4">
                {CAST_AVATARS.map((src, i) => (
                  <img
                    key={i}
                    src={src}
                    className="w-12 h-12 rounded-full border-2 border-[#0b0d14]"
                    alt="Cast"
                  />
                ))}
              </div>
      ...
      <div className="px-8 md:px-16 py-8">
        <div className="flex justify-between items-end mb-8">
          ...
          <div className="flex gap-2">
            <button className="p-3 rounded-full border border-gray-700 text-white hover:bg-white hover:text-black transition">
              <ChevronLeft size={16} />
            </button>
            <button className="p-3 rounded-full border border-gray-700 text-white hover:bg-white hover:text-black transition">
